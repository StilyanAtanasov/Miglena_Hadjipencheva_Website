...
namespace MHAuthorWebsite.Data.Migrations
{
    ...
    [Migration("20260222214116_AddUpdatedOnFlagOnProductsAndWorks")]
    partial class AddUpdatedOnFlagOnProductsAndWorks
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MHAuthorWebsite.Core.Models.Announcement", b =>
                {
                    ...
                    b.Property<string>("MessageDelta")
                        .IsRequired()
            ...
            modelBuilder.Entity("MHAuthorWebsite.Core.Models.ScheduledNotification", b =>
                {
                    ...
                    b.Property<string>("TargetDeliveryDetails")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("MHAuthorWebsite.Core.Models.CartItem", b =>
                {
                    b.HasOne("MHAuthorWebsite.Core.Models.Cart", "Cart")
                        .WithMany("CartItems")
                        .HasForeignKey("CartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MHAuthorWebsite.Core.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("MHAuthorWebsite.Core.Models.OrderProduct", b =>
                {
                    b.HasOne("MHAuthorWebsite.Core.Models.Order", "Order")
            ...
            modelBuilder.Entity("MHAuthorWebsite.Core.Models.Product", b =>
                {
                    b.HasOne("MHAuthorWebsite.Core.Models.ProductType", "ProductType")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("MHAuthorWebsite.Core.Models.ProductAttribute", b =>
                {
                    b.HasOne("MHAuthorWebsite.Core.Models.ProductAttributeDefinition", "AttributeDefinition")
                        .WithMany()
                        .HasForeignKey("AttributeDefinitionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MHAuthorWebsite.Core.Models.ProductAttributeOption", "ProductAttributeOption")
            ...
            modelBuilder.Entity("MHAuthorWebsite.Core.Models.ProductComment", b =>
                {
                    b.HasOne("MHAuthorWebsite.Core.Models.ProductComment", "ParentComment")
                        .WithMany("Replies")
                        .HasForeignKey("ParentCommentId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("MHAuthorWebsite.Core.Models.ProductComment", "ParentReply")
                        .WithMany()
            ...
            modelBuilder.Entity("MHAuthorWebsite.Core.Models.ProductCommentImage", b =>
                {
                    b.HasOne("MHAuthorWebsite.Core.Models.ProductComment", "Comment")
                        .WithMany("Images")
            ...
            modelBuilder.Entity("MHAuthorWebsite.Core.Models.ProductThumbnail", b =>
                {
                    b.HasOne("MHAuthorWebsite.Core.Models.ProductImage", "Image")
                        .WithMany()
                        .HasForeignKey("ImageId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MHAuthorWebsite.Core.Models.ProductImage", "ImageOriginal")
                        .WithMany()
                    ...
                    b.HasOne("MHAuthorWebsite.Core.Models.Product", "Product")
                        .WithOne("Thumbnail")
                        .HasForeignKey("MHAuthorWebsite.Core.Models.ProductThumbnail", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MHAuthorWebsite.Core.Models.ScheduledNotification", b =>
                {
                    b.HasOne("MHAuthorWebsite.Core.Models.ApplicationUser", "Recipient")
                        .WithMany()
            ...
            modelBuilder.Entity("MHAuthorWebsite.Core.Models.Shipment", b =>
                {
                    b.HasOne("MHAuthorWebsite.Core.Models.Order", "Order")
                        .WithOne("Shipment")
                        .HasForeignKey("MHAuthorWebsite.Core.Models.Shipment", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MHAuthorWebsite.Core.Models.ShipmentEvent", b =>
                {
                    b.HasOne("MHAuthorWebsite.Core.Models.Shipment", "Shipment")
                        .WithMany("Events")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MHAuthorWebsite.Core.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ProductsLikes", b =>
                {
                    b.HasOne("MHAuthorWebsite.Core.Models.Product", null)
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
