...
namespace MHAuthorWebsite.Data.Migrations
{
    ...
    [Migration("20251121170932_LinkProductWithDiscount")]
    partial class LinkProductWithDiscount
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MHAuthorWebsite.Data.Models.ProductDiscount", b =>
                {
                    b.HasOne("MHAuthorWebsite.Data.Models.Product", "Product")
                        .WithOne("Discount")
                        .HasForeignKey("MHAuthorWebsite.Data.Models.ProductDiscount", "ProductId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
