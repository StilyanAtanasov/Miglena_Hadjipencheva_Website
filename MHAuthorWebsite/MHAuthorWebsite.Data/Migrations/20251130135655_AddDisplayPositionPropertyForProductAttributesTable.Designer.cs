...
namespace MHAuthorWebsite.Data.Migrations
{
    ...
    [Migration("20251130135655_AddDisplayPositionPropertyForProductAttributesTable")]
    partial class AddDisplayPositionPropertyForProductAttributesTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MHAuthorWebsite.Data.Models.ContactRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MHAuthorWebsite.Data.Models.ProductAttribute", b =>
                {
                    ...
                    b.Property<int>("DisplayPosition")
                        ...
                        .HasColumnType("int")
                        .HasDefaultValue(0)
                        .HasComment("Defines in which section of the product's details page will it appear");
            ...
            modelBuilder.Entity("MHAuthorWebsite.Data.Models.ContactRequest", b =>
                {
                    b.HasOne("MHAuthorWebsite.Data.Models.ApplicationUser", "Admin")
                        .WithMany()
