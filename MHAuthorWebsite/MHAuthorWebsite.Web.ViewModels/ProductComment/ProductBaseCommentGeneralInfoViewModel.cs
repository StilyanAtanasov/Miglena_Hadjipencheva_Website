...
public class ProductBaseCommentGeneralInfoViewModel
{
    ...
    public ICollection<ProductCommentReplyGeneralInfoViewModel> Replies { get; set; } = new HashSet<ProductCommentReplyGeneralInfoViewModel>();
}